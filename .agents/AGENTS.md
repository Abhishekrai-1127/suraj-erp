...
- **Legacy Mock Purging & Table Deletion Controls**: Added auto-sanitization of legacy coded/mock entities ("Lumina Marketing", "Apex Corp Solutions", etc.) in [erp-storage.js](file:///Users/abhii/Documents/GitHub/suraj-erp/src/lib/erp-storage.js), and integrated inline row deletion controls across Sales Orders ([orders/page.js](file:///Users/abhii/Documents/GitHub/suraj-erp/src/app/(dashboard)/sales/orders/page.js)) and Invoices ([invoices/page.js](file:///Users/abhii/Documents/GitHub/suraj-erp/src/app/(dashboard)/sales/invoices/page.js)).
